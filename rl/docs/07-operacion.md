...
| Re-asalto no baja incomplete / blob sigue idle en el tent | **Capa 0, no Capa 2:** rally al dest + stance AttackAnything al spawn (`auto_support`). Tabla en `13-capa0-status-post-run8.md` *Órdenes vs scripted*. |

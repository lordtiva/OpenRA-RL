...
> **Macro-first / 2070 8 GB:** preset `eradicate_v5`; `TRAIN_ARGS` usa `--xf-topk 0 --qsa-topk 0`. Dashboard: `dashboard.html?dir=rl/ckpts_v2` (reward exchange/tier + shaper). Ver [`../design/macro-first.md`](../design/macro-first.md).

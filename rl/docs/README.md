...
| **13b** | `13-capa0-status-post-run8.md` | **Capa 0/1. Run 14 harv-leak. Rally tent-only + dest-credit skip harv, resume 899. APC post Capa 2** | **Companion del 12 — 2026-08-30** |
